...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(726, 76);
			this->label1->TabIndex = 0;
			this->label1->Text = L"—ангвиник-флегматик\r\n";
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 40, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(249, 568);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(370, 126);
			...
			this->label2->Size = System::Drawing::Size(850, 385);
