...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(5, 198);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(859, 63);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Ошибка! Пройдите тест ещё раз!";
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 40, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(269, 547);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(338, 74);
